...
public class Board {
	...
	/**
	 * given a move the board makes the move except if InvalidMoveException is thrown.
	 * 
	 ...
	 * @param colDest
	 */
	public void move(int rowTail, int colTail, int rowHead, int colHead, int rowDest, int colDest) throws InvalidMoveException {
		move(new Move(this, rowTail, colTail, rowHead, colHead, rowDest, colDest));
	}
