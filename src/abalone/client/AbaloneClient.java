...
public class AbaloneClient implements ClientProtocol {
     ...
     * pm.START;whitePlayerName;whitePlayerTeam;blackPlayerName;blackPlayerTeam
     *     [;bluePlayerName;bluePlayerTeam;redPlayerName;redPlayerTeam]
     * and starts it
     */
    ...
    /**
     * Get the next color in rotation. Dependant on the number of players.
     */
    ...
    public void sendMove(String arg1, String arg2, String arg3) throws ServerUnavailableException {
        sendMessage(ProtocolMessages.MOVE + ProtocolMessages.DELIMITER + arg1
                + ProtocolMessages.DELIMITER + arg2
    ...
    /**
     * Switches client to another team.
     */
    ...
    /**
     * Get the current color in the rotation.
     */
