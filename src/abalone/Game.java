...
public abstract class Game {
    ...
    /**
     * Plays the game until there is a winner or the turn limit is
     * reached (draw).
...
//            System.out.println("DRAW!");
    ...
    /**
     * Makes the team arrays based on the given number of
     * players in the game.
     * @param numberOfPlayers 2 to 4
     * @return
     */
     ...
     * @returns string including the number of turns performed and left,
     *     as well as the toString() of the board
     */
