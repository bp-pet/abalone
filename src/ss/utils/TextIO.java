...
public class TextIO {
     ...
     * NOTE: Calling this method starts a GUI user interface thread, which can continue
     ...
     * @param minChars The minimum number of char
     */
    ...
    private static final Pattern floatRegex = Pattern.compile(
            "(\\+|-)?(([0-9]+(\\.[0-9]*)?)|(\\.[0-9]+))((e|E)(\\+|-)?[0-9]+)?");
